...
#define INJ_CTF_RUN_AND_FORGET      0x00010000 
#define CTF_MASK (INJ_CTF_FAKE_START_ADDRESS | INJ_CTF_HIDE_FROM_DEBUGGER | INJ_CTF_SKIP_THREAD_ATTACH | INJ_CTF_FAKE_TEB_CLIENT_ID | INJ_CTF_RUN_AND_FORGET)
