...
DebugCheckResult debuggerChecks[] = {
    /*      {false, "VCH Integrity (LBR)",
        .functionPtr = VchIntegrityCheck}, // 放在前面执行 */
    ...
    // {false, "DebugObjectHandle", .functionPtrWithProcess =
    // DebugObjectHandle}, {false, "KernelDebugger", .functionPtr =
    // KernelDebugger}, {false, "NtGlobalFlag", .functionPtr = NtGlobalFlag},
    ...
    // {false, "DuplicatedHandles", .functionPtrWithProcess =
    // DuplicatedHandles}, {false, "ParentProcesses", .functionPtrWithProcess =
    // ParentProcesses}, {false, "NtSetLdtEntries", .functionPtr =
    // CheckNtSetLdtEntries}, {false, "PEB", .functionPtr = CheckPEB}, {false,
    // "DebugPort", .functionPtrWithProcess = DebugPort}, {false,
    // "HardwareBreakpoint", .functionPtrWithThread = HardwareBreakpoint},
